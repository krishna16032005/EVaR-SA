...
C2 & It is cheaper than SPSA at matched sample budget
   & \opn{} &
     Not yet run. One backprop replaces $2N_t$ rollouts by construction, but the
     head-to-head is unexecuted \\[0.4em]
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../results/figures/report/solver_scale.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../results/figures/report/dual_objective.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.66\textwidth]{../results/figures/report/solver_precision.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.86\textwidth]{../results/figures/gridworld/gridworld_environment.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../results/figures/gridworld/gridworld_c3_mechanism.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.49\textwidth]{../results/figures/dsac/dsac-pendulum_dsac_return.pdf}
\hfill
\includegraphics[width=0.49\textwidth]{../results/figures/dsac/dsac-pendulum_dsac_dual_x.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.49\textwidth]{../results/figures/dsac/dsac-safety-nav_dsac_return.pdf}
\hfill
\includegraphics[width=0.49\textwidth]{../results/figures/dsac/dsac-safety-nav_dsac_cost.pdf}
...
\subsection{Open}
\begin{enumerate}[leftmargin=1.5em,itemsep=0.2em]
\item \textbf{C2: the SPSA head-to-head at matched sample budget.} Not run. The
      gridworld is where it is runnable --- episodes are three steps. \opn
...
\item \textbf{The SPSA head-to-head on the gridworld} --- closes C2, and is cheap.
